...
public enum BizCodeEnum {
    ...
    STRATEGY_DESIGN_DOMAIN_DELETED_FAILED(100016, "战略设计领域删除失败"),
    STRATEGY_DESIGN_BUSINESS_REL_DOMAIN_INSERTED_FAILED(100017, "战略设计业务关联领域插入失败"),
    STRATEGY_DESIGN_BUSINESS_REL_DOMAIN_UPDATED_FAILED(100018, "战略设计业务关联领域更新失败"),
    STRATEGY_DESIGN_BUSINESS_REL_DOMAIN_DELETED_FAILED(100020, "战略设计业务关联领域删除失败"),
    STRATEGY_DESIGN_DOMAIN_RELATION_DELETED_FAILED(100021, "战略设计领域关系删除失败"),
    STRATEGY_DESIGN_DOMAIN_RELATION_INSERTED_FAILED(100022, "战略设计领域关系插入失败"),
    STRATEGY_DESIGN_DOMAIN_CODE_IS_NULL(100023, "战略设计领域编码是空"),
