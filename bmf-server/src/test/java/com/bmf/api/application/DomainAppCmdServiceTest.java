...
public class DomainAppCmdServiceTest {
    ...
    public void test_domain_app_api_create() {
        ...
        domainAppApi_1.setServiceCode(10001);
        domainAppApi_1.setServiceAlias("outbound_create_order_service");
        ...
        domainAppApi_2.setServiceCode(10002);
        domainAppApi_2.setServiceAlias("inbound_create_order_service");
