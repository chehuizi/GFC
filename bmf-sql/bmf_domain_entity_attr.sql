CREATE TABLE `bmf_domain_entity_attr` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `entity_id_code` int(11) NOT NULL COMMENT '实体ID编码',
  `attr_name` varchar(64) NOT NULL COMMENT '实体属性名称',
  `attr_type` varchar(64) NOT NULL COMMENT '实体属性类型',
  `attr_desc` varchar(64) NOT NULL COMMENT '实体属性描述',
